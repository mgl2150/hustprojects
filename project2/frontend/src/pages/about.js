            ...
            <div className="flex flex-col gap-y-16 pt-32 px-4">
                ...
                <div className="flex flex-row flex-wrap gap-x-48 gap-y-8 justify-center ">
                     <div className="flex flex-col my-auto gap-y-4">
                        ...
                        <p className="max-w-[450px] text-xl md:text-lg">PetMama là một cửa hàng chuyên cung cấp thú cưng và sản phẩm vật nuôi chất lượng. Với cả cửa hàng truyền thống và cửa hàng trực tuyến, PetMama là phương án dự phòng khi startup crypto thất bại (let's hope not)..</p>
                    </div>
                    <div>
                ...
                <div className="flex flex-col items-center pt-16 text-black">
                    ...
                    <p className="font-extrabold text-3xl max-w-[500px] text-center">Dog is more deserving than Human (trust me bro)</p>
                ...
                <div className="flex flex-row md:flex-wrap gap-x-48 gap-y-8 justify-center md:pt-16 pt-8 flex-wrap-reverse">
                    ...
                    <div className="flex flex-col my-auto gap-y-4">
                        ...
                        <p className="max-w-[450px] text-xl md:text-lg"></p>
                    </div>
                </div> 
